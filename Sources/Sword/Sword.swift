...
open class Sword: Eventable {
    ...
    public func connect() {
        ...
        if self.options.willShard {
            self.getGateway() { [self] data, error in
    ...
    public func createGuild(
        ...
        self.request(.createGuild, body: options) { [self] data, error in
            if let error = error {
                completion?(nil, error)
            }else {
    ...
    public func deleteChannel(
        ...
        self.request(.deleteChannel(channelId)) { [self] data, error in
            if let error = error {
                completion?(nil, error)
            }else {
    ...
    public func deleteGuild(
        ...
        self.request(.deleteGuild(guildId)) { [self] data, error in
            if let error = error {
                completion?(nil, error)
            }else {
                completion?(Guild(self, data as! [String: Any]), nil)
    ...
    public func getBans(
        ...
        self.request(.getGuildBans(guildId)) { [self] data, error in
            if let error = error {
                completion(nil, error)
            }else {
    ...
    public func getChannel(
        ...
        self.request(.getChannel(channelId)) { [self] data, error in
            if let error = error {
                completion(nil, error)
            }else {
                let channelData = data as! [String: Any]
    ...
    public func getChannels(
        ...
        self.request(.getGuildChannels(guildId)) { [self] data, error in
            if let error = error {
                completion(nil, error)
            }else {
    ...
    public func getGuild(
        ...
        self.request(.getGuild(guildId)) { [self] data, error in
            if let error = error {
                completion(nil, error)
            }else {
                completion(Guild(self, data as! [String: Any]), nil)
    ...
    public func getGuildWebhooks(
        ...
        self.request(.getGuildWebhooks(guildId)) { [self] data, error in
            if let error = error {
                completion(nil, error)
            }else {
    ...
    public func getPinnedMessages(
        ...
        self.request(.getPinnedMessages(channelId)) { [self] data, error in
            if let error = error {
                completion(nil, error)
            }else {
                var returnMessages = [Message]()
    ...
    public func getUser(
        ...
        self.request(.getUser(userId)) { [self] data, error in
            if let error = error {
                completion(nil, error)
            }else {
    ...
    public func getWebhook(
        ...
        self.request(.getWebhook(webhookId, token)) { [self] data, error in
            if let error = error {
                completion(nil, error)
            }else {
                completion(Webhook(self, data as! [String: Any]), nil)
    ...
    public func getWebhooks(
        ...
        self.request(.getChannelWebhooks(channelId)) { [self] data, error in
            if let error = error {
                completion(nil, error)
            }else {
                var returnWebhooks = [Webhook]()
